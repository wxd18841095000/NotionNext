...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Jakin', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '世人哪、耶和华已指示你何为善。他向你所要的是甚么呢。只要你行公义、好怜悯、存谦卑的心、与你的　神同行。', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://csmpblog.hisword.win', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Hisword', // 网站关键词 英文逗号隔开
  ...
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || true,'wxd18841095000@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  CONTACT_YOUTUBE: process.env.NEXT_PUBLIC_CONTACT_YOUTUBE || true,'https://www.youtube.com/@csmp-3418', // Youtube主页
  // 其它复杂配置
  ...
  GREETING_WORDS:
    ...
    'Hi，欢迎来到主的话语中：洪水泛滥之时，耶和华坐着为王；耶和华坐着为王，直到永远。',

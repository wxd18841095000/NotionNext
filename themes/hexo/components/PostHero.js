    ...
    <div id='header' className='w-full h-96 relative md:flex-shrink-0 z-10'>
      ...
      <header
        ...
        <div className='mt-10'>
          ...
          {/* 文章Title */}
          <div
            id='article-print-title'
            className='leading-snug font-bold xs:text-4xl sm:text-4xl md:text-5xl md:leading-snug text-4xl shadow-text-md flex justify-center text-center text-white'>
          ...
          <section
            id='article-print-meta'
            className='flex-wrap shadow-text-md flex text-sm justify-center mt-4 text-white dark:text-gray-400 font-light leading-8'>
